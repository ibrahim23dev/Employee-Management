                    ...
                    <div className='h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap'>
                        <div className='md-lg:w-full w-3/12 md-lg:pt-4'>
                            <div className='flex justify-between items-center'>
                                <Link to='/'>
                                    <img className='w-full h-[80px]' src="http://localhost:3001/logo1.png" alt="logo" />
                                </Link>
            ...
            <div className='hidden md-lg:block'>
                ...
                <div className={`w-[300px] z-[9999] transition-all duration-200 fixed  ${showShidebar ? '-left-[300px]' : 'left-0'} top-0 overflow-y-auto bg-white h-screen py-6 px-8`}>
                    <div className='flex justify-start flex-col gap-6'>
                        <Link to='/'>
                           <img className='w-full h-[100px]' src="http://localhost:3001/logo1.png" alt="logo" />
                        </Link>
                        ...
                        <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                            ...
                            <div className='flex justify-end flex-col gap-1'>
                                <h2 className='text-sm font-medium text-slate-700'>+8801315974775</h2>
                        ...
                        <ul className='flex flex-col justify-start items-start gap-3 text-[#1c1c1c]'>
                            ...
                            <span className='text-sm'>Daffodil Eco Shop</span>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            ...
                            <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    ...
                                    <div className='flex justify-end flex-col gap-1'>
                                        <h2 className='text-md font-medium text-slate-700'>+88 01315974775</h2>
                                        <span className='text-sm'>support 24 hr</span>
                                    </div>
                                </div>
                            </div>
                        </div>
          ...
          <div className='flex w-full justify-between items-center h-[50px] text-slate-500'>
            <ul className='flex justify-start items-center gap-8'>
              ...
              <div className='flex cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-0 '>
                <img className='w-[35px] h-[25px]' src='http://localhost:3001/images/language.png' alt='' />
                <span><MdOutlineKeyboardArrowDown /></span>
        ...
        <div className='w-[85%]  lg:w-[90%] mx-auto'>
          <div className='h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap'>
            <div className='md-lg:w-full w-3/12 md-lg:pt-4'>
              <div className='flex justify-between items-center'>
                <Link to='/'>
                  <img className='w-[75%] h-[80%]' src='http://localhost:3001/logo1.png' alt='logo'/>
                </Link>
