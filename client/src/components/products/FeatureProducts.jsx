        ...
        return (
            <div className='w-[85%] flex flex-wrap mx-auto'>
                ...
                <div className='w-full grid grid-cols-4 md-lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-6'>
                    {
                        [1, 2, 3, 4, 5, 6, 7, 8].map((p, i) => <div key={i} className='border group transition-all duration-500 hover:shadow-md hover:-mt-3'>
                            <div className='relative overflow-hidden'>
                                ...
                                <img className='sm:w-full w-full h-[240px]' src={`http://localhost:3001/images/products/${p}.jpg`} alt="product image" />
                                <ul className='flex transition-all duration-700 -bottom-10 justify-center items-center gap-2 absolute w-full group-hover:bottom-3'>
                                    ...
                                    <Link to={`/product/details/${p}`} className='w-[38px] h-[38px] cursor-pointer bg-white flex justify-center items-center rounded-full hover:bg-[#7fad39] hover:text-white hover:rotate-[720deg] transition-all' ><FaEye /></Link>
                            ...
                            <div className='py-3 text-slate-600 px-2'>
                                <h2>Olevs leather waterproof quartz fashion watch for men</h2>
